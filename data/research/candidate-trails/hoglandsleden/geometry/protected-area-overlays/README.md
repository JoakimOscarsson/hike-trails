# hoglandsleden protected-area overlays

Research-only protected-area clipping artifact for hoglandsleden candidate normalization.
...
- Rebuild with `npm run data:candidate-overlays:hoglandsleden`.
