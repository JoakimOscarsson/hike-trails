# bohusleden protected-area overlays

Research-only protected-area clipping artifact for bohusleden candidate normalization.
...
- Rebuild with `npm run data:candidate-overlays:bohusleden`.
