# ostkustleden protected-area overlays

Research-only protected-area clipping artifact for ostkustleden candidate normalization.
...
- Rebuild with `npm run data:candidate-overlays:ostkustleden`.
